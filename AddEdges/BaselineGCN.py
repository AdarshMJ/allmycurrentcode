...
import argparse
parser = argparse.ArgumentParser(description='Run BaselineGCN script')
parser.add_argument('--path', type=str, default='Insert Path', help='path to directory containing npz file')
