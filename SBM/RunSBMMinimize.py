...
plt.savefig("Plots/MinimizeGap/SBMinallsame/SBMAfterPruningallsame.jpg")
...
visualize(out, color=newdata.y,legend_labels=["Class 1", "Class 2"],title='Embeddings before training',filename="Plots/MinimizeGap/SBMinallsame/BeforeTraining+PruneMinallsame.jpg")
...
plt.ylabel('Loss')
plt.legend()
plt.savefig("Plots/MinimizeGap/SBMinallsame/LossSBMinallsame.png")
...
plt.ylabel('NMI')
plt.legend()
plt.savefig("Plots/MinimizeGap/SBMinallsame/TestNMISBMinallsame.png")


print("After training GCN, visualizing node embeddings...")
model.eval()
out = model(newdata.x, newdata.edge_index)
visualize(out, color=newdata.y,legend_labels=["Class 1", "Class 2"],title=f'Embeddings after training - NMI: {nmi:.3f}',filename = 'Plots/MinimizeGap/SBMinallsame/AfterTraining+PruneMinallsame.jpg')