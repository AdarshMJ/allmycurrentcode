import argparse
parser = argparse.ArgumentParser(description='Run SDRF GCN script')
...
######### Hyperparams to use #############
## Cora --> Dropout = 0.3130296 ; LR = 0.01 ; Hidden_Dimension = 128
## Citeseer --> Dropout = 0.2130296 ; LR = 0.01 ; Hidden_Dimension = 32
