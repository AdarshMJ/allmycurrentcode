...
parser.add_argument('--path', type=str, default='/content/drive/MyDrive/OLDNEURIPSCODE/NODECLASSIFICATION/heterophilous-graphs/data/done', help='path to directory containing npz file')
...
#Cornell = 0.2130296, 0.001, 128
#Wisconsin = 0.2130296, 0.001, 128
#Texas = 0.2130296, 0.001, 128
#Actor = 0.2130296, 0.01, 128
#Squirrel = 0.3130296, 0.01, 128
#Chameleon = 0.2130296, 0.01, 128
